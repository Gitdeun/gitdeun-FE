    ...
    <div className="flex flex-col items-center w-full">
      <div className="flex flex-col items-center w-full mt-[120px] gap-6">
        ...
        <button
          ...
          className="bg-sky-100 text-sky-600 font-bold text-lg px-[24px] py-[12px] rounded-full hover:scale-105 transition-transform duration-200"
        >
          마인드맵 만들러가기
        </button>
      </div>
      ...
      <div className="flex gap-[28px] mt-[150px]">
        ...
        {/* 카드 2 */}
        <div className="flex flex-col gap-6 w-[330px] items-center justify-between text-center">
          <img src={login2} alt="collaborate icon" className="w-11 h-11" />
        ...
        {/* 카드 3 */}
        <div className="flex flex-col gap-6 w-[330px] items-center justify-between text-center">
          <img src={login3} alt="suggest icon" className="w-11 h-11" />
